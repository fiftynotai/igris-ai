...
|------|----------|-----------|
| Project | `~/.igris/projects/{project}/context/*.md` | Permanent |
| Session | `~/.igris/projects/{project}/session/CURRENT_SESSION.md` | Per-session |
| Agent | Brief file Agent Log | Per-brief |
| Recovery | `~/.igris/projects/{project}/session/checkpoints/` | 7 days |
...
2. **Read active brief via `igris_brief_get` or cache at `~/.igris/projects/{project}/briefs/`**
...
|------|---------|------------------|
| `~/.igris/projects/{project}/session/CURRENT_SESSION.md` | Project-level brief tracking | When briefs start/complete |
| `Brief files` | All task/workflow state for that brief | Every task/agent change |
| `~/.igris/projects/{project}/session/BLOCKERS.md` | Active blockers | When blocked |
| `~/.igris/projects/{project}/session/DECISIONS.md` | Architectural decisions | When making decisions |
| `~/.igris/projects/{project}/session/LEARNINGS.md` | Discoveries and patterns | When learning something |
