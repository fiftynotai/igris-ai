...
**Coding Guidelines:**
- Standard violated: `~/.igris/projects/{project}/context/coding_guidelines.md#[section-name]`
- Specific guideline:
  > [Quote the exact guideline being violated from coding_guidelines.md]

- Target pattern: `~/.igris/projects/{project}/context/coding_guidelines.md#[target-section]`
- Code examples: `~/.igris/projects/{project}/context/coding_guidelines.md#[examples-section]`

**Note:** If coding guidelines don't exist yet, run `STANDARDIZE analyze` first.

**Architecture Documentation:**
- Architecture pattern: `~/.igris/projects/{project}/context/architecture_map.md#[section]`
- Module structure: `~/.igris/projects/{project}/context/module_catalog.md#[module-name]`
...
**Standards Applied:**
- [ ] Based on project coding guidelines (`~/.igris/projects/{project}/context/coding_guidelines.md`)
